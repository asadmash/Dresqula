...
const Testimonial = () => {
  return (
    <div className="@container">
      <div className="container_inner py-16 ">
        ...
        <div className="grid lg:grid-cols-[300px_1fr] gap-4">
          <div className="border border-gray-200 rounded-2xl grid place-items-center p-6 lg:p-0">
            <div className="text-center flex flex-col items-center gap-1">
              ...
              <p className="max-w-[200px] text-gray-500">Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
            </div>
          </div>

          <div className="bg-red-600 bg-[url(/cta-banner.jpg)] bg-cover h-[500] rounded-2xl grid place-items-center">
